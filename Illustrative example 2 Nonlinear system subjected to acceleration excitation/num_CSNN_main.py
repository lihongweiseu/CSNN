# %% CSNN for the numerical case (Sec 3.1)  of Ref:
...
# # Save model
# torch.save(CSNN_model.state_dict(), "num_CSNN_2layer1_2state_2neuron1_3000_loss5316em2.pt")

# %%
file_dir = os.path.join(case_dir, 'num_CSNN_2layer1_2state_2neuron1_3000_loss5316em2.pt')
...
savemat(file_dir, {'Train_y': Train_y, 'Train_y_l': Train_y_l, 'Test_y': Test_y, 'Test_y_l': Test_y_l})
